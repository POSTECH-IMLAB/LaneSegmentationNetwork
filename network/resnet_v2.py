...
import math
from network import resnet_utils
from utils.tf_util import kernels, conv2d, multi_conv2d_layer, max_pooling, avg_pooling, scale_conv2d_layer
...
@slim.add_arg_scope
def bottleneck(inputs, depth, depth_bottleneck, stride, unit_rate=1, rate=1, multi_rates=None, scale_rates=None,
...
def resnet_v2(inputs,
    ...
    with tf.variable_scope(scope, 'resnet_v2', [inputs], reuse=reuse) as sc:
        ...
        with slim.arg_scope([slim.conv2d, bottleneck, resnet_utils.stack_blocks_dense],
            ...
            with slim.arg_scope([multi_conv2d_layer, slim.batch_norm],
                ...
                # Calculate block functions
                net, auxiliary = resnet_utils.stack_blocks_dense(net, blocks, output_stride)
                ...
                return net, end_points, auxiliary
...
_DEFAULT_MULTI_GRID = (1, 2, 4)


def resnet_v2_30(inputs,
                 num_classes=None,
                 is_training=True,
                 global_pool=True,
                 output_stride=None,
                 ...
                 reuse=None,
                 scope='resnet_v2_30'):
    """ResNet-30 model of [1]. See resnet_v2() for arg and return description."""
...
resnet_v2_30.default_image_size = resnet_v2.default_image_size
